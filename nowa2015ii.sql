...
--
-- Host: 127.0.0.1
-- Czas generowania: 06 Sty 2020, 20:11
...
CREATE TABLE `kierowcy` (
  `id_kierowcy` varchar(10) NOT NULL,
...
CREATE TABLE `wyniki` (
  ...
  `id_wyscigu` varchar(5) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `wyniki` (`id_kierowcy`, `punkty`, `id_wyscigu`) VALUES
('z31', 10, 'w1'),
('z42', 6, 'w1'),
('z46', 4, 'w1'),
('z13', 2, 'w1'),
...
CREATE TABLE `wyscigi` (
  `id_wyscigu` varchar(5) NOT NULL,
  `rok` char(4) DEFAULT NULL,
  `GrandPrix` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
